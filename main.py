...
# ========== [1] 텔레그램 API 설정 ==========
API_ID = int(os.getenv("API_ID", "26645796"))
API_HASH = os.getenv("API_HASH", "b7db273be4f9075232b6c8103ec870fe")
PHONE_NUMBER = os.getenv("PHONE_NUMBER", "+818020523071")  # 예시
...
# ========== [2] 홍보용 계정(마케팅 계정) ==========
MARKETING_USER = "@cuz_z"  # 예시: 유저네임 or 정수 ID
